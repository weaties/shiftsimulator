...
from shiftsim.geometry import (angle_between, bearing_of, cross, dot, unit,
                               wrap180, wrap360)


def test_unit_compass_directions():
    n = unit(0); e = unit(90); s = unit(180); w = unit(270)
