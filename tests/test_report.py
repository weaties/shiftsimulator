...
CONFIG = {
    ...
    "boats": [
        {"name": "HH", "color": "#f00", "initial_tack": "starboard",
         "maneuver_time": 12, "maneuver_speed_factor": 0.45,
